...
VALUES
	...
	('MRK001', 'ICT1212', 10.0, 1.5, 28.0, 10.0, 30.0, 8.5, 'TG1486'),
    ('MRK002', 'ICT1222', 9.5, 2.0, 15.0, 8.0, 35.0, 12.5, 'TG1486'),
    ('MRK003', 'ICT1233', 7.0, 3.0, 17.0, 9.0, 20.0, 10.0, 'TG1486'),
    ('MRK004', 'ICT1242', 9.0, 4.0, 10.0, 12.0, 15.0, 28.0, 'TG1486'),
    ('MRK005', 'ICT1253', 8.5, 5.0, 30.0, 3.0, 20.0, 16.5, 'TG1486'),
    ('MRK006', 'TMS1233', 9.0, 3.0, 25.0, 8.0, 22.0, 10.0, 'TG1486'),
    ('MRK007', 'TCS1212', 6.5, 1.0, 19.0, 10.0, 28.0, 10.0, 'TG1486'),
    ('MRK008', 'ENG1212', 9.5, 2.0, 8.0, 20.0, 48.5, 0.0, 'TG1486'),

    ('MRK009', 'ICT1212', 9.5, 1.5, 20.0, 8.0, 25.0, 14.0, 'TG1511'),
    ('MRK010', 'ICT1222', 10.0, 2.0, 15.0, 8.0, 30.0, 10.5, 'TG1511'),
    ('MRK011', 'ICT1233', 9.0, 4.0, 20.0, 10.0, 22.0, 22.5, 'TG1511'),
    ('MRK012', 'ICT1242', 8.0, 3.5, 12.0, 11.0, 27.5, 17.0, 'TG1511'),
    ('MRK013', 'ICT1253', 7.0, 5.0, 15.0, 13.0, 28.0, 15.0, 'TG1511'),
    ('MRK014', 'TMS1233', 6.5, 3.0, 28.0, 4.0, 25.0, 0.0, 'TG1511'),
    ('MRK015', 'TCS1212', 10.0, 2.5, 20.0, 7.0, 48.5, 0.0, 'TG1511'),
    ('MRK016', 'ENG1212', 4.5, 3.0, 10.0, 12.0, 31.5, 0.0, 'TG1511'),

    ('MRK017', 'ICT1212', 10.0, 1.0, 19.0, 10.0, 35.0, 5.0, 'TG1002'),
    ('MRK018', 'ICT1222', 8.5, 2.0, 20.0, 12.0, 20.0, 10.5, 'TG1002'),
    ('MRK019', 'ICT1233', 9.5, 2.5, 22.0, 6.0, 12.0, 22.0, 'TG1002'),
    ('MRK020', 'ICT1242', 7.0, 5.0, 18.0, 10.0, 29.0, 10.0, 'TG1002'),
    ('MRK021', 'ICT1253', 3.0, 4.0, 23.0, 8.0, 42.0, 5.0, 'TG1002'),
    ('MRK022', 'TMS1233', 5.5, 3.0, 21.0, 6.0, 42.0, 0.0, 'TG1002'),
    ('MRK023', 'TCS1212', 7.5, 1.5, 23.0, 3.0, 28.5, 0.0, 'TG1002'),
    ('MRK024', 'ENG1212', 9.5, 2.0, 21.0, 9.0, 39.5, 0.0, 'TG1002'),

	('MRK025', 'ICT1212', 10.0, 3.0, 10.0, 5.0, 35.0, 10.5, 'TG1534'),
    ('MRK026', 'ICT1222', 8.0, 2.5, 22.0, 6.0, 30.0, 16.5, 'TG1534'),
    ('MRK027', 'ICT1233', 9.0, 1.0, 29.0, 0.0, 19.0, 20.0, 'TG1534'),
    ('MRK028', 'ICT1242', 3.0, 4.0, 28.0, 2.0, 32.0, 15.0, 'TG1534'),
    ('MRK029', 'ICT1253', 8.0, 2.0, 20.0, 5.0, 20.0, 15.0, 'TG1534'),
    ('MRK030', 'TMS1233', 6.0, 2.5, 15.0, 7.0, 30.5, 5.0, 'TG1534'),
    ('MRK031', 'TCS1212', 8.5, 1.5, 20.0, 6.0, 20.0, 3.0, 'TG1534'),
    ('MRK032', 'ENG1212', 9.0, 2.0, 25.0, 4.0, 35.0, 2.0, 'TG1534'),

    ('MRK033', 'ICT1212', 8.5, 2.0, 20.0, 5.0, 22.0, 27.5, 'TG1367'),
    ('MRK034', 'ICT1222', 7.5, 3.0, 22.0, 7.0, 22.0, 10.5, 'TG1367'),
    ('MRK035', 'ICT1233', 8.0, 4.0, 20.0, 3.0, 32.0, 10.0, 'TG1367'),
    ('MRK036', 'ICT1242', 7.0, 2.5, 20.0, 8.0, 31.5, 22.0, 'TG1367'),
    ('MRK037', 'ICT1253', 10.0, 5.0, 26.0, 7.0, 32.0, 10.0, 'TG1367'),
    ('MRK038', 'TMS1233', 6.5, 2.0, 10.0, 2.0, 40.0, 4.5, 'TG1367'),
    ('MRK039', 'TCS1212', 3.0, 1.5, 25.0, 4.0, 35.5, 11.0, 'TG1367'),
    ('MRK040', 'ENG1212', 8.0, 3.0, 22.0, 9.0, 30.0, 15.0, 'TG1367'),

    ('MRK041', 'ICT1212', 9.5, 4.0, 20.0, 10.0, 32.0, 10.5, 'TG1548'),
    ('MRK042', 'ICT1222', 10.0, 2.5, 20.0, 5.5, 30.0, 13.0, 'TG1548'),
    ('MRK043', 'ICT1233', 7.5, 3.0, 20.0, 2.0, 24.0, 20.0, 'TG1548'),
    ('MRK044', 'ICT1242', 8.0, 5.0, 15.0, 8.0, 20.0, 28.0, 'TG1548'),
    ('MRK045', 'ICT1253', 3.0, 1.5, 27.0, 3.0, 41.5, 6.0, 'TG1548'),
    ('MRK046', 'TMS1233', 5.5, 2.0, 10.0, 4.0, 31.5, 5.0, 'TG1548'),
    ('MRK047', 'TCS1212', 6.5, 3.0, 18.0, 6.0, 22.0, 7.5, 'TG1548'),
    ('MRK048', 'ENG1212', 9.0, 1.0, 25.0, 7.0, 35.0, 10.0, 'TG1548'),

    ('MRK049', 'ICT1212', 8.0, 2.5, 21.0, 6.0, 22.0, 11.5, 'TG1342'),
    ('MRK050', 'ICT1222', 9.5, 1.5, 24.0, 4.0, 30.0, 10.0, 'TG1342'),
    ('MRK051', 'ICT1233', 6.0, 2.0, 15.0, 10.0, 30.0, 15.0, 'TG1342'),
    ('MRK052', 'ICT1242', 9.5, 3.0, 20.0, 5.0, 22.5, 10.0, 'TG1342'),
    ('MRK053', 'ICT1253', 8.0, 2.5, 30.0, 2.0, 25.0, 11.5, 'TG1342'),
    ('MRK054', 'TMS1233', 10.0, 1.0, 16.0, 8.0, 31.0, 8.0, 'TG1342'),
    ('MRK055', 'TCS1212', 6.0, 2.0, 18.0, 11.0, 38.0, 0.0, 'TG1342'),
    ('MRK056', 'ENG1212', 7.5, 1.5, 20.0, 7.0, 32.0, 11.0, 'TG1342'),

    ('MRK057', 'ICT1212', 9.5, 3.5, 18.0, 12.0, 11.0, 19.0, 'TG1256'),
    ('MRK058', 'ICT1222', 5.5, 2.0, 21.0, 2.0, 31.0, 15.5, 'TG1256'),
    ('MRK059', 'ICT1233', 8.5, 2.5, 22.0, 10.0, 20.0, 18.0, 'TG1256'),
    ('MRK060', 'ICT1242', 5.0, 1.0, 20.0, 5.0, 21.0, 10.0, 'TG1256'),
    ('MRK061', 'ICT1253', 8.5, 3.0, 20.0, 9.0, 28.0, 21.0, 'TG1256'),
    ('MRK062', 'TMS1233', 3.5, 2.0, 17.0, 3.0, 25.0, 14.0, 'TG1256'),
    ('MRK063', 'TCS1212', 4.5, 1.5, 24.0, 8.0, 32.0, 0.0, 'TG1256'),
    ('MRK064', 'ENG1212', 7.0, 2.0, 28.0, 6.0, 20.5, 8.0, 'TG1256'),

	('MRK065', 'ICT1212', 8.0, 4.5, 26.5, 2.0, 26.0, 20.0, 'TG1490'),
	('MRK066', 'ICT1222', 5.5, 3.0, 20.0, 1.5, 24.5, 21.0, 'TG1490'),
	('MRK067', 'ICT1233', 7.0, 4.0, 20.5, 3.5, 30.0, 10.0, 'TG1490'),
	('MRK068', 'ICT1242', 9.0, 2.5, 20.0, 1.0, 30.5, 16.0, 'TG1490'),
	('MRK069', 'ICT1253', 6.0, 5.0, 18.0, 0.0, 20.0, 24.0, 'TG1490'),
	('MRK070', 'TMS1233', 9.5, 3.0, 26.0, 2.0, 14.5, 15.0, 'TG1490'),
	('MRK071', 'TCS1212', 10.0, 2.5, 20.0, 0.0, 22.5, 11.0, 'TG1490'),
	('MRK072', 'ENG1212', 10.0, 4.0, 22.5, 1.5, 30.0, 14.0, 'TG1490'),

	('MRK073', 'ICT1212', 5.0, 3.0, 22.5, 0.5, 30.0, 19.0, 'TG1682'),
	('MRK074', 'ICT1222', 8.5, 2.0, 22.0, 1.5, 29.0, 17.0, 'TG1682'),
	('MRK075', 'ICT1233', 9.5, 1.5, 24.5, 0.0, 28.0, 11.5, 'TG1682'),
	('MRK076', 'ICT1242', 10.0, 3.5, 15.0, 2.0, 29.5, 10.0, 'TG1682'),
	('MRK077', 'ICT1253', 8.5, 4.0, 17.0, 0.0, 20.5, 25.0, 'TG1682'),
	('MRK078', 'TMS1233', 10.0, 2.0, 28.0, 1.0, 31.0, 15.0, 'TG1682'),
	('MRK079', 'TCS1212', 8.5, 1.5, 19.5, 0.0, 34.5, 14.0, 'TG1682'),
	('MRK080', 'ENG1212', 9.0, 3.5, 13.0, 2.5, 32.0, 10.0, 'TG1682'),

	('MRK081', 'ICT1212', 8.0, 3.0, 14.5, 2.0, 30.0, 15.5, 'TG1745'),
	('MRK082', 'ICT1222', 7.0, 2.5, 23.0, 0.0, 20.0, 12.5, 'TG1745'),
	('MRK083', 'ICT1233', 5.5, 4.5, 28.0, 1.0, 27.0, 20.0, 'TG1745'),
	('MRK084', 'ICT1242', 4.0, 1.5, 26.0, 0.0, 26.5, 20.0, 'TG1745'),
	('MRK085', 'ICT1253', 8.5, 3.0, 25.0, 1.0, 26.0, 16.5, 'TG1745'),
	('MRK086', 'TMS1233', 10.0, 2.0, 20.5, 0.0, 19.0, 18.5, 'TG1745'),
	('MRK087', 'TCS1212', 10.0, 3.5, 15.0, 0.0, 22.5, 23.0, 'TG1745'),
	('MRK088', 'ENG1212', 9.5, 2.5, 6.0, 1.5, 22.5, 19.0, 'TG1745'),

	('MRK089', 'ICT1212', 9.0, 4.0, 16.5, 0.0, 15.0, 25.5, 'TG1381'),
	('MRK090', 'ICT1222', 7.0, 3.5, 24.0, 1.0, 27.0, 13.5, 'TG1381'),
	('MRK091', 'ICT1233', 8.5, 2.5, 22.0, 3.0, 21.0, 23.0, 'TG1381'),
	('MRK092', 'ICT1242', 5.5, 2.0, 18.0, 0.5, 26.0, 23.0, 'TG1381'),
	('MRK093', 'ICT1253', 10.0, 3.0, 10.5, 2.0, 19.5, 22.0, 'TG1381'),
	('MRK094', 'TMS1233', 9.0, 2.5, 12.0, 0.0, 24.5, 20.0, 'TG1381'),
	('MRK095', 'TCS1212', 5.5, 1.5, 24.0, 1.0, 18.0, 16.0, 'TG1381'),
	('MRK096', 'ENG1212', 9.0, 3.5, 12.5, 0.5, 22.0, 20.5, 'TG1381'),

	('MRK097', 'ICT1212', 8.0, 2.0, 15.0, 0.0, 20.0, 25.0, 'TG1573'), 
    ('MRK098', 'ICT1222', 7.5, 3.0, 12.0, 1.0, 18.0, 18.5, 'TG1573'), 
    ('MRK099', 'ICT1233', 9.0, 4.0, 16.5, 10.0, 14.0, 15.0, 'TG1573'),  
    ('MRK100', 'ICT1242', 10.0, 2.5, 14.0, 0.0, 18.0, 16.5, 'TG1573'),
    ('MRK101', 'ICT1253', 9.5, 3.0, 17.0, 1.5, 15.0, 15.0, 'TG1573'), 
    ('MRK102', 'TMS1233', 8.5, 2.5, 16.0, 0.0, 17.0, 16.0, 'TG1573'), 
    ('MRK103', 'TCS1212', 9.0, 3.5, 12.0, 1.5, 10.0, 16.0, 'TG1573'), 
    ('MRK104', 'ENG1212', 10.0, 3.0, 15.0, 0.5, 18.0, 16.5, 'TG1573')  

	('MRK105', 'ICT1212', 10.0, 2.5, 24.0, 1.0, 30.5, 15.0, 'TG1821'), 
    ('MRK106', 'ICT1222', 4.0, 3.0, 22.5, 0.5, 19.0, 27.0, 'TG1821'), 
    ('MRK107', 'ICT1233', 9.5, 2.0, 21.0, 0.0, 30.5, 13.0, 'TG1821'), 
    ('MRK108', 'ICT1242', 9.0, 3.5, 24.0, 1.5, 22.0, 21.0, 'TG1821'),  
    ('MRK109', 'ICT1253', 6.0, 1.5, 23.0, 7.0, 30.0, 11.5, 'TG1821'), 
    ('MRK110', 'TMS1233', 8.5, 3.0, 27.0, 0.0, 30.0, 19.0, 'TG1821'), 
    ('MRK111', 'TCS1212', 4.0, 1.0, 22.5, 5.0, 20.0, 24.5, 'TG1821'), 
    ('MRK112', 'ENG1212', 7.5, 2.5, 24.0, 0.5, 20.5, 22.0, 'TG1821')  

	('MRK113', 'ICT1212', 9.0, 4.0, 20.0, 5.0, 28.0, 12.0, 'TG1995'), 
    ('MRK114', 'ICT1222', 7.5, 3.5, 16.0, 5.0, 30.0, 15.0, 'TG1995'),
    ('MRK115', 'ICT1233', 8.0, 5.0, 18.0, 4.0, 26.0, 15.0, 'TG1995'), 
    ('MRK116', 'ICT1242', 6.5, 3.0, 17.0, 7.0, 24.0, 22.0, 'TG1995'), 
    ('MRK117', 'ICT1253', 2.5, 2.5, 19.0, 6.0, 25.0, 18.0, 'TG1995'),
    ('MRK118', 'TMS1233', 9.5, 4.5, 22.0, 3.0, 27.0, 21.0, 'TG1995'), 
    ('MRK119', 'TCS1212', 8.0, 3.5, 20.0, 5.5, 29.0, 15.0, 'TG1995'), 
    ('MRK120', 'ENG1212', 10.0, 4.0, 18.0, 6.0, 30.0, 18.0, 'TG1995');
